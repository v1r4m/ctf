## overall
토요일, 10 1 2026, 09:00 KST - 월요일, 12 1 2026, 09:00 KST
### Team Rank
* 2372 score
* #8
### diary
...
일단은 budget을 통과하는 cnn이 다음 숫자로 인식하는 파일을 만들어야 했다. [주피터 노트북](u0ftctf2026/rec.ipynb)으로 코드를 올려놨긴 했는데 쓸만한 코드는 거의 하나도 없고 그냥 대부분 검증, 삽질이고 마지막 코드블록이 핵심이다 왜 정리를 안해서올렷냐면 어차피 클로드님이 쓰신코드인데 내가뭘더첨삭하리요
